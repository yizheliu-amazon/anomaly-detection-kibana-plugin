...
import { getIndices, createIndex } from '../../../redux/reducers/elasticsearch';
...
export function AnomalyDetectionOverview(props: AnomalyDetectionOverviewProps) {
  ...
  return props.isLoadingDetectors ? (
    ...
    <Fragment>
      ...
      <EuiText>
        An anomaly is any unusual change in behavior. Anomalies in your
        time-series data can lead to valuable insights. For example, for IT
        infrastructure data, an anomaly in the memory usage metric might help
        you uncover early signs of a system failure. To learn more,{' '}
        <EuiLink
          href="https://opendistro.github.io/for-elasticsearch-docs/docs/ad/"
          target="_blank"
        >
          see our documentation <EuiIcon size="s" type="popout" />
        </EuiLink>
        . Get started by{' '}
        <EuiLink href={`${PLUGIN_NAME}#${APP_PATH.CREATE_DETECTOR_STEPS}`}>
          creating a detector
        </EuiLink>
        .
      </EuiText>
      ...
      <ContentPanel title="How it works">
        <EuiFlexGroup>
          ...
          <CreateWorkflowStepDetails
            ...
            content="Run your detector to observe results in real-time. You can also enable historical analysis to view anomalies in your data's past history. "
          />
        </EuiFlexGroup>
      </ContentPanel>
      <EuiSpacer size="xl" />
